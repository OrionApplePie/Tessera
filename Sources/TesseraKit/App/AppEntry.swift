...
/// The application, as the executable beside this library calls it.
///
/// `@main` belongs to the executable target: this is the one thing the library
/// makes public, and `Sources/Tessera/main.swift` is one line calling it.
@MainActor
public enum TesseraApp {
